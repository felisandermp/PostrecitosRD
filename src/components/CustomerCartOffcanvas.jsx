...
const CustomerCartOffcanvas = () => {
  ...
  const handleCheckout = async (e) => {
    ...
    try {
      ...
      // Guardar en localStorage (en producción sería Firebase)
      const customerOrders = JSON.parse(localStorage.getItem('customerOrders') || '[]');
      const newOrder = {
        id: Date.now().toString(),
        ...orderData,
        type: 'online' // Identificar que es pedido online
      };
      customerOrders.push(newOrder);
      localStorage.setItem('customerOrders', JSON.stringify(customerOrders));
      
      // También guardar en el formato del admin para que aparezca en el sistema
      const adminOrders = JSON.parse(localStorage.getItem('orders') || '[]');
      
      // Crear timestamp en formato compatible con mockDB
      const now = new Date();
      const timestamp = {
      ...
      const adminOrder = {
        ...
        total,
        paymentMethod,
        userId: 'online-customer', // Identificador para pedidos online
        status: 'pendiente',
        customerInfo: customerInfo, // Información del cliente
        type: 'online',
        createdAt: timestamp, // Formato compatible con mockDB
        updatedAt: timestamp
      };
      ...
      const newInvoice = {
        ...
        invoiceNumber,
        orderId: newOrder.id,
        date: timestamp, // Usar el mismo timestamp
        customer: {
        ...
        type: 'online',
        userId: 'online-customer',
        createdAt: timestamp // Agregar createdAt
      };
          ...
          {cart.length > 0 ? (
              ...
              {!showCheckoutForm ? (
                ...
                <>
                  ...
                  <div className="flex-grow-1 overflow-auto p-3">
                    ...
                    <h6 className="mb-3">Información de Entrega</h6>
            ...
            <div className="d-flex flex-column align-items-center justify-content-center h-100 p-4">
              ...
              <p className="text-muted text-center small">
                Explora nuestros deliciosos postres
              </p>
              <button 
